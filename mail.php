...
$emailadmin = 'order@snegoffon.ru';//e-mail админа
$mes = "Человек по имени $name отправил сообщение из формы обратной связи Snegoffon.ru:

$message  

Телефон: $subject $comtext";
...
/*
    ...
    $emailgo->from_email= 'admin@snegoffon.ru'; // от кого
    $emailgo->from_name= 'Компания OOO "Snegov"';
